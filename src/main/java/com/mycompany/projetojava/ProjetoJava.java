...
import entities.FilaRestaurante;
...
public class ProjetoJava {
        ...
        while (running) {
            ...
            switch (op) {
                ...
                case 2:
                    ...
                    break;
                case 3:
                    restauranteMenu(restauran, pedido, mesa, listaMesas, listaPedidos, filaRestaurante, pilhaMesa, clinica);
                    break;
                case 0:
                    running = false;
                    break;
    ...
    public static void clinicaMenu(ClinicaMedica clinica, Medicos medico, Pacientes paciente, ListaEncadeadaPacientes listaPacientes, FilaPaciente filaPaciente) throws ParseException {
        ...
        while (clinicRunning) {
            ...
            System.out.println("5. Desfazer Consulta");
            System.out.println("6. Buscar Médicos");
            System.out.println("7. Agendar consulta");
            System.out.println("8. Editar histórico do paciente");
            System.out.println("9. Médicos mais requisitados");
            ...
            switch (op) {
                ...
                case 5:
                    filaPaciente.desfazerAtendimento();
                    break;
                case 6:
    ...
    public static void restauranteMenu(Restaurante restauran, Pedidos pedido, Mesas mesa, ListaEncadeadaMesa listaMesas, ListaEncadeadaPedidos listaPedidos, FilaRestaurante filaRestaurante, PilhaMesa pilhaMesa, ClinicaMedica clinica) {
        Scanner s = new Scanner(System.in);
        SimpleDateFormat sdf = new SimpleDateFormat("dd/MM/yyyy");
        ...
        while (restRunning) {
            ...
            System.out.println("3. Desfazer última alteração");
            ...
            switch (restOp) {
                ...
                case 2:
                    ...
                    if (buscarNumeroMesa != null) {
                        ...
                        System.out.println("1. Pizza - R$30.00(100s)");
                        System.out.println("2. Hambúrguer - R$20.00(60s)");
                        System.out.println("3. Salada - R$15.00(15s)");
                        System.out.println("4. Refrigerante - R$5.00(10s)");
                        System.out.println("0. Sair");
                        ...
                        switch (opcaoPedido) {
                            ...
                            case 1:
                                ...
                                pedido = new Pedidos(nomePedido, tempo, quantidadePedido, precoPedido);
                                buscarNumeroMesa.addPedidos(pedido);

                                filaRestaurante.adicionarPedido(pedido);
                ...
                case 4:
                    ...
                    filaRestaurante.processarPedido();
                    break;
                case 5:
